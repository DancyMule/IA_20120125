...
function update() {
    ...
    despBala3 = Math.floor( jugador.position.x - bala.position.x );
...
*/
    ...
    if( bala2.position.y >= 220  ){
        resetVariables2();
    }

    if( bala2.position.x <= 0  || bala2.position.y >= 220 ){
        resetVariables3();
    }
