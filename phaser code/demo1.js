...
function create() {
    ...
    nnNetwork =  new synaptic.Architect.Perceptron(4, 5, 5, 5, 4);
...
function datosDeEntrenamiento(param_entrada){
    console.log("Entrada",param_entrada[0]+" "+param_entrada[1]+" "+param_entrada[2]+" "+param_entrada[3]+" "+param_entrada[4]+" "+param_entrada[5]+" "+param_entrada[6]);
    ...
    return nnSalida[0]>=nnSalida[1], nnSalida[2]>=nnSalida[3];
}
...
function update() {
    ...
    despBala2 = Math.floor( jugador.position.x - bala.position.x );
    despBalaHorizontal3 = Math.floor( jugador.position.x - bala.position.x );
    despBalaVertical3 = Math.floor( jugador.position.y - bala.position.y );
...
*/
    ...
    if( modoAuto==false && avanza.isDown &&  jugador.body.onFloor() && jugador.position.x <= 150 && estatusIzquierda){
        correr();
    }

    if( modoAuto==false && !avanza.isDown &&  jugador.body.onFloor() && jugador.position.x >= 150 ){
        correrAtras();
    }
    ...
    if( modoAuto == true  && bala.position.x>0 && jugador.body.onFloor()) {
        ...
        if( datosDeEntrenamiento( [despBala , velocidadBala, despBala2, velocidadBala2, despBalaHorizontal3, velocidadBala3, despBalaVertical3, velocidadBala3] )  ){
            saltar();
            correr();
        }
    }
    ...
    if( modoAuto ==false  && bala.position.x > 0 ){
        ...
        datosEntrenamiento.push({
                'input' :  [despBala , velocidadBala, despBala2, velocidadBala2, despBalaHorizontal3, despBalaVertical3, velocidadBala3],
